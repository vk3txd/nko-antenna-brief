...
6A. [Gray-line and terminator propagation](#6a-gray-line-and-terminator-propagation)
7. [Critical frequency, foF2, MUF, LUF, OWF, and usable bands](#7-critical-frequency-fof2-muf-luf-owf-and-usable-bands)
7A. [Space weather, solar cycles, and why the bands can sound dead](#7a-space-weather-solar-cycles-and-why-the-bands-can-sound-dead)
7B. [The hiss we hear: atmospheric, galactic, man-made, and solar noise](#7b-the-hiss-we-hear-atmospheric-galactic-man-made-and-solar-noise)
...
8A. [Ducted and chordal modes](#8a-ducted-and-chordal-modes)
8B. [NEC modelling: what it can and cannot tell you about HF copy](#8b-nec-modelling-what-it-can-and-cannot-tell-you-about-hf-copy)
...
13A. [Practical reciprocity, non-reciprocal QSB, and what operators really hear](#13a-practical-reciprocity-non-reciprocal-qsb-and-what-operators-really-hear)
